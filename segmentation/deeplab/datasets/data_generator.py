...
_NYUV2_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 795,  # num of samples in images/training
        'val': 654,  # num of samples in images/validation
    },
    num_classes=14,
    ignore_label=0,
)

_NYUV2_8_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 795,  # num of samples in images/training
        'val': 654,  # num of samples in images/validation
    },
...
_PEPPER_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        ...
        'val': 50,  # num of samples in images/validation
    },
    num_classes=9,
    ignore_label=0,
)
...
_DATASETS_INFORMATION = {
    ...
    'nyuv2': _NYUV2_INFORMATION,
    'nyuv2_8': _NYUV2_8_INFORMATION,
